    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm min-h-[460px] flex flex-col justify-between">
            ...
            <div class="mt-6 border-t border-gray-100 dark:border-gray-800 pt-4 text-center">
                <div class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">حسن اختيارك هو بداية مشوارك</div>
                <div class="text-[9px] text-primary-500 dark:text-primary-400 font-bold mt-0.5">#وجهتك-تبدأ-من-هنا</div>
            </div>
        </div>
    </div>
