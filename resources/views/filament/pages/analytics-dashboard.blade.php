<x-filament-panels::page>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
            <h3 class="text-md font-bold mb-4 text-gray-700 dark:text-gray-300 flex items-center gap-2">
                ...
                {{ __('filament-pages.analytics_dashboard.attendance_reports') }}
            </h3>

            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1">{{ __('filament-pages.analytics_dashboard.select_event') }}</label>
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-2">
                    <button wire:click="downloadAttendancePdf" class="flex-1 bg-primary-600 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded-lg text-xs transition-all flex items-center justify-center gap-2 shadow-sm">
                        ...
                        {{ __('filament-pages.analytics_dashboard.download_pdf') }}
                    </button>
                    <button wire:click="downloadAttendanceExcel" class="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg text-xs transition-all flex items-center justify-center gap-2 shadow-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        {{ __('filament-pages.analytics_dashboard.export_excel') }}
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
            <h3 class="text-md font-bold mb-4 text-gray-700 dark:text-gray-300 flex items-center gap-2">
                ...
                {{ __('filament-pages.analytics_dashboard.survey_reports') }}
            </h3>

            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1">{{ __('filament-pages.analytics_dashboard.select_evaluation') }}</label>
    ...
    <!-- Charts Section -->
    <div class="mt-6">
        <h3 class="text-md font-bold mb-4 text-gray-700 dark:text-gray-300">{{ __('filament-pages.analytics_dashboard.charts_insights') }}</h3>
